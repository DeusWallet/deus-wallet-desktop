...
import {
  ...
  bottomTabBarRoutes,
  swapAndMarketRoutes,
} from '@deushq/kit/src/routes/Root/Main/Tab/routes/tabRoutes.base';
import type { TabRoutes } from '@deushq/kit/src/routes/routesEnum';
import { PortalContainer } from '@deushq/kit/src/views/Overlay/RootPortal';
