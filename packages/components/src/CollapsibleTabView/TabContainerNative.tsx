...
import NestedTabView from '@deushq/app/src/views/NestedTabView/NestedTabView';
import type {
  OnPageChangeEvent,
  TabProps,
} from '@deushq/app/src/views/NestedTabView/types';
import { useThemeValue } from '@deushq/components';
