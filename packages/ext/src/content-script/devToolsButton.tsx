const BTN_ID = 'deus-inpage-debug-dev-tools-button';
const BTN_TEXT = 'RELOAD';
const IFRAME_ID = 'deus-inpage-debug-dev-tools-iframe';
...
function injectDevToolsButton() {
  ...
  devToolsButton.title =
    'Reload Deus extension and this site, make injected.js updated.';
  ...
  devToolsButton.addEventListener('click', () => {
    try {
      ...
      console.log('========================================');
      console.log('>>>>>>>> Deus Extension reloading in 3s...');
