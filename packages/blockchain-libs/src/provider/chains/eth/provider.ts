...
import { BaseProvider } from '@deushq/engine/src/client/BaseClient';
import type {
  AddressValidation,
  SignedTx,
  TypedMessage,
...
import type { Signer, Verifier } from '@deushq/engine/src/types/secret';
import { check, checkIsDefined } from '@deushq/shared/src/utils/assertUtils';
import {
  fromBigIntHex,
  toBigIntHex,
} from '@deushq/shared/src/utils/numberUtils';
...
class Provider extends BaseProvider {
  ...
  override signMessage = async (
    ...
    // https://deushq.atlassian.net/browse/OK-18748
    try {
