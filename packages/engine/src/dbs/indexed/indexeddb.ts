...
import {
  decrypt,
  encrypt,
} from '@deushq/engine/src/secret/encryptors/aes256';
import {
  filterPassphraseWallet,
  handleDisplayPassphraseWallet,
} from '@deushq/shared/src/engine/engineUtils';

import {
  AccountAlreadyExists,
  NotImplemented,
  DeusAlreadyExistWalletError,
  DeusInternalError,
...
class IndexedDBApi implements DBAPI {
  ...
  constructor() {
    this.ready = new Promise((resolve, reject) => {
      ...
      request.onerror = (_event) => {
        reject(new DeusInternalError('Failed to open DB.'));
      };
  ...
  getContext(): Promise<DeusContext | null | undefined> {
      ...
      (db) =>
        new Promise((resolve, _reject) => {
          const request = db
            ...
            .get(MAIN_CONTEXT);
          request.onsuccess = (_event) => {
            resolve(request.result as DeusContext);
          };
        }),
    );
  }
      ...
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to update password.'));
          };
          ...
          getMainContextRequest.onsuccess = (_event) => {
            const context = getMainContextRequest.result as DeusContext;
      ...
      (db) =>
        new Promise((resolve, reject) => {
          ...
          deleteRequest.onerror = (_devent) => {
            reject(new DeusInternalError('Failed to delete db.'));
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to add network.'));
          };
        ...
        new Promise((resolve, reject) => {
          ...
          request.onsuccess = (_event) => {
            if (!isNil(request.result)) {
              ...
              reject(
                new DeusInternalError(`Network ${networkId} not found.`),
              );
            }
          };
        }),
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to update network list.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve();
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to update network.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to delete network.'));
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to add token.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to add token to account.'));
          };
          transaction.oncomplete = (_tevent) => {
            if (!isNil(token)) {
              resolve(token);
              ...
              reject(
                new DeusInternalError('Failed to add token to account.'),
              );
            }
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(
              new DeusInternalError('Failed to remove token from account.'),
            );
          };
          transaction.oncomplete = (_tevent) => {
            resolve();
        ...
        new Promise((resolve, _reject) => {
          ...
          request.onsuccess = (_event) => {
            const getMainContextRequest = transaction
              ...
              .get(MAIN_CONTEXT);
            getMainContextRequest.onsuccess = (_cevent) => {
              const context: DeusContext =
                getMainContextRequest.result as DeusContext;
              if (!isNil(context)) {
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to create HD wallet.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          };
    ...
    return this.ready.then(
      (db) =>
        ...
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to add HW Wallet.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          };
          ...
          getAllWalletsRequest.onsuccess = () => {
            ...
            getDevicesRequest.onsuccess = async (_devent) => {
              ...
              if (hasExistWallet) {
                ...
                reject(
                  new DeusAlreadyExistWalletError(
                    hasExistWallet.id,
                    hasExistWallet.name,
                  ),
                );
              ...
              getNewDeviceRequest.onsuccess = () => {
                ...
                getWalletRequest.onsuccess = (_wevent) => {
                  ...
                  if (wallet && !passphraseState) {
                    reject(
                      new DeusAlreadyExistWalletError(wallet.id, wallet.name),
                    );
                    return;
                  }
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to remove wallet.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve();
          };
          ...
          getWalletRequest.onsuccess = (_wevent) => {
            ...
            if (isNil(wallet)) {
              reject(new DeusInternalError(`Wallet ${walletId} not found.`));
              return;
            }
            if (
              ...
              reject(
                new DeusInternalError('Only HD or HW wallet can be removed.'),
              );
              return;
            }
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to set wallet name.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          };
  ...
  createPrivateKeyCredential(
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          if (!credential) {
            reject(new DeusInternalError('Credential required.'));
            return;
          }
          const transaction = db.transaction(
            [CONTEXT_STORE_NAME, CREDENTIAL_STORE_NAME],
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(
              new DeusInternalError('Failed to confirm HD wallet backup.'),
            );
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(
              new DeusInternalError('Failed to confirm HD wallet created.'),
            );
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          ...
          getMainContextRequest.onsuccess = (_cevent) => {
            ...
            getWalletRequest.onsuccess = (_event) => {
              ...
              if (isNil(wallet)) {
                reject(
                  new DeusInternalError(`Wallet ${walletId} not found.`),
                );
                return;
              }
              ret = wallet;
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to add account to wallet.'));
          };
          transaction.oncomplete = (_tevent) => {
            if (!isNil(ret)) {
              resolve(ret);
              ...
              reject(
                new DeusInternalError('Failed to add account to wallet.'),
              );
            }
          };
        ...
        new Promise((resolve, reject) => {
          ...
          request.onsuccess = (_event) => {
            ...
            if (cursor) {
              ...
              reject(new DeusInternalError(`Account ${address} not found.`));
            }
          };
        }),
    );
        ...
        new Promise((resolve, reject) => {
          ...
          request.onsuccess = (_event) => {
            if (!isNil(request.result)) {
              ...
              reject(
                new DeusInternalError(`Account ${accountId} not found.`),
              );
            }
          };
        }),
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to remove account.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve();
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to set account name.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve(ret);
          };
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to add history entry.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve();
          };
      ...
      request.onsuccess = (_event) => {
        ...
        if (isNil(device)) {
          ...
          addDeviceRequest.onerror = () =>
            reject(new DeusInternalError(`Failed to create device.`));
        } else {
          reject(new DeusInternalError(`Device ${name} has alerday exists.`));
        }
      };
    });
  }
        ...
        new Promise((resolve, reject) => {
          ...
          request.onsuccess = (_event) => {
            if (!isNil(request.result)) {
              ...
              reject(new DeusInternalError(`Device ${deviceId} not found.`));
            }
          };
        }),
    );
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = () => {
            reject(new DeusInternalError('Failed to update wallet name.'));
          };
          ...
          getWalletRequest.onsuccess = () => {
            ...
            if (isNil(wallet)) {
              reject(new DeusInternalError('Wallet not found.'));
              return;
            }
            ...
            getDeviceRequest.onsuccess = () => {
              ...
              if (isNil(device)) {
                reject(new DeusInternalError('Device not found.'));
                return;
              }
    ...
    return this.ready.then(
      (db) =>
        new Promise((resolve, reject) => {
          ...
          transaction.onerror = (_tevent) => {
            reject(new DeusInternalError('Failed to update device.'));
          };
          transaction.oncomplete = (_tevent) => {
            resolve();
          };
          ...
          request.onsuccess = (_event) => {
            if (!isNil(request.result)) {
              ...
              if (device) {
                ...
                reject(
                  new DeusInternalError(`Device ${deviceId} not found.`),
                );
              }
            }
          };
      ...
      (db) =>
        new Promise((resolve, reject) => {
          ...
          if (!derivationStore) {
            ...
            transaction.onerror = () => {
              reject(
                new DeusInternalError('Failed to add account derivation.'),
              );
            };
    ...
    return new Promise((resolve, reject) => {
      ...
      getExistRecordRequest.onsuccess = (_event) => {
        if (isNil(getExistRecordRequest.result)) {
          reject(new DeusInternalError(`AccountDerivation ${id} not found.`));
        }
        const accountDerivation = getExistRecordRequest.result;
