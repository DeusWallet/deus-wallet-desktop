...
import type { RevealableSeed } from '@deushq/engine/src/secret';
...
const DEFAULT_VERIFY_STRING = 'Deus';
const MAIN_CONTEXT = 'mainContext';

export const DEFAULT_RPC_ENDPOINT_TO_CLEAR: Record<string, string> = {
  [DeusNetwork.eth]:
    'https://mainnet.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161',
  [DeusNetwork.bsc]: 'https://bsc-dataseed1.binance.org',
  [DeusNetwork.polygon]: 'https://polygon-rpc.com',
};

function checkPassword(context: DeusContext, password: string): boolean {
  if (!context) {
