...
import type { ExtendedKey } from '@deushq/engine/src/secret';
import type { Bip32KeyDeriver } from '@deushq/engine/src/secret/bip32';
import { BaseBip32KeyDeriver } from '@deushq/engine/src/secret/bip32';
...
import { toPsbtNetwork } from '@deushq/shared/src/providerApis/ProviderApiBtc/ProviderApiBtc.utils';
...
export class KeyringImported extends KeyringImportedBase {
  ...
  override async getSigners(
    ...
    if (relPaths.length === 0) {
      throw new DeusInternalError('No signers would be chosen.');
    }
