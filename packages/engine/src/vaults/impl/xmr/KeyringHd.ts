...
import { COINTYPE_XMR as COIN_TYPE } from '@deushq/shared/src/engine/engineConsts';
...
export class KeyringHd extends KeyringHdBase {
  async prepareAccounts(
    ...
    if (!rawPrivateKey) {
      throw new DeusInternalError('Unable to get raw private key.');
    }
    ...
    for (const index of indexes) {
      ...
      if (!publicSpendKey || !publicViewKey) {
        throw new DeusInternalError('Unable to get public spend/view key.');
      }
