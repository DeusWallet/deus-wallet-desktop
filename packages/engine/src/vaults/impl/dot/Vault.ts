...
import type { BaseClient } from '@deushq/engine/src/client/BaseClient';
import {
  InvalidAddress,
...
import { formatBalanceDisplay } from '@deushq/kit/src/components/Format';
...
export default class Vault extends VaultBase {
  ...
  override async broadcastTransaction(
    ...
    try {
      ...
      throw new DeusInternalError(message);
    }
  }
