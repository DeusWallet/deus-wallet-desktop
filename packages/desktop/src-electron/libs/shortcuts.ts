...
import type { ExplorerShortcutEvents } from '@deushq/shared/src/shortcuts/shortcuts.enum';
import { getShortcutsMap } from '@deushq/shared/src/shortcuts/shortcuts.enum';
