...
import type { HeaderTitleProps } from '@deushq/components/src/NavHeader/HeaderTitle';
import type { PriceAlertItem } from '@deushq/engine/src/managers/notification';
import type { BulkTypeEnum } from '@deushq/engine/src/types/batchTransfer';
import type { Network } from '@deushq/engine/src/types/network';
import type { Collection } from '@deushq/engine/src/types/nft';
import type { DAppItemType } from '@deushq/kit/src/views/Discover/type';
...
export type ModalRoutesParams = {
  ...
  [ModalRoutes.DeusLiteReset]: NavigatorScreenParams<SubModalRoutesParams.DeusLiteResetRoutesParams>;
  [ModalRoutes.DeusLiteChangePinInputPin]: NavigatorScreenParams<SubModalRoutesParams.DeusLiteChangePinRoutesParams>;
  ...
  [ModalRoutes.DeusHardware]: NavigatorScreenParams<SubModalRoutesParams.DeusHardwareRoutesParams>;
...
export type HomeRoutesParams = {
  ...
  [HomeRoutes.ScreenDeusLiteDetail]: undefined;
