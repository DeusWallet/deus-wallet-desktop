...
import type { IDesktopOpenUrlEventData } from '@deushq/desktop/src-electron/app';
import type { DesktopAPI } from '@deushq/desktop/src-electron/preload';
...
const processDeepLinkUrl = memoizee(
  ...
  (url: string | undefined): IDeepLinkUrlParsedResult | undefined => {
    try {
      ...
      // ** ios UniversalLink
      //        https://app.deus.so/wc/connect/wc?uri=wc%3Aeb16df1f-1d3b-4018-9d18-28ef610cc1a4%401%3Fbridge%3Dhttps%253A%252F%252Fj.bridge.walletconnect.org%26key%3D0037246aefb211f98a8386d4bf7fd2a5344960bf98cb39c57fb312a098f2eb77
      if (
        hostname === 'app.deus.so' &&
      ...
      //        deus-wallet://wc
      // deus-wallet://wc?uri=wc%3Afa75a793-a3fb-48e4-8629-8f1f034ec6eb%401%3Fbridge%3Dhttps%253A%252F%252Fy.bridge.walletconnect.org%26key%3D9e97f71a32b4e629cb60106295dca54d733d124da480b4031d0d848b678fd610/
      if (
        scheme === DEUS_APP_DEEP_LINK ||
        scheme === DEUS_APP_DEEP_LINK_NAME
      ) {
        if (
