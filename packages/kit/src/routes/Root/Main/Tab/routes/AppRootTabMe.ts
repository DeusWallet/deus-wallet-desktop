import { withTabLayout } from '@deushq/components/src/Layout/withTabLayout';
...
import DeusLiteDetail from '../../../../../views/Hardware/DeusLite/Detail';
...
const config: TabRouteConfig = {
  ...
  children: [
    {
      name: HomeRoutes.ScreenDeusLiteDetail,
      component: DeusLiteDetail,
    },
    {
