...
export type { DeusLiteChangePinRoutesParams } from './HardwareDeusLiteChangePin';
export type { DeusLiteResetRoutesParams } from './HardwareDeusLiteReset';
...
export type { DeusHardwareRoutesParams } from './HardwareDeus';
