...
const DeusHardwareModal = createLazyComponent(
  () => import('./HardwareDeus'),
);
const HardwareDeusLitePinModal = createLazyComponent(
  () => import('./HardwareDeusLiteChangePin'),
);
const HardwareDeusResetModal = createLazyComponent(
  () => import('./HardwareDeusLiteReset'),
);
...
const modalStackScreenList = [
  ...
  {
    name: ModalRoutes.DeusLiteReset,
    component: HardwareDeusResetModal,
  },
  {
    name: ModalRoutes.DeusLiteChangePinInputPin,
    component: HardwareDeusLitePinModal,
  },
  {
  ...
  {
    name: ModalRoutes.DeusHardware,
    component: DeusHardwareModal,
  },
  {
