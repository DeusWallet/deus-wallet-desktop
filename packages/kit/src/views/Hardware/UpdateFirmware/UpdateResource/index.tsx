...
import RestartTouch from '@deushq/kit/assets/animations/restart-touch.json';
import SelectFirmwareResources from '@deushq/kit/assets/select_firmware_resources.png';
import SelectFirmwareResourcesDark from '@deushq/kit/assets/select_firmware_resources_dark.png';
          ...
          if (error) {
            ...
            switch (error.message) {
              ...
              case ERRORS.MAS_DISK_PATH_PERMISSION_DENIED:
                ...
                setConfirmChooseDisk(false);
                message = intl.formatMessage({
                  id: 'msg__unable_to_access_disk_deus_data',
                });
                return;
