...
import MacSecurityPrivacyLightImage from '@deushq/kit/assets/mac_security_and_privacy.png';
import MacSecurityPrivacyDarkImage from '@deushq/kit/assets/mac_security_and_privacy_dark.png';
