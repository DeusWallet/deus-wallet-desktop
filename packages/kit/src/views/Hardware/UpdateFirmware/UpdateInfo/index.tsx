...
import TouchConnectDesktop from '@deushq/kit/assets/illus_touch_connect_desktop.png';
import backgroundApiProxy from '@deushq/kit/src/background/instance/backgroundApiProxy';
import { useSettings } from '@deushq/kit/src/hooks/redux';
import type { HardwareUpdateRoutesParams } from '@deushq/kit/src/routes/Root/Modal/HardwareUpdate';
import { HardwareUpdateModalRoutes } from '@deushq/kit/src/routes/routesEnum';
import type { ModalScreenProps } from '@deushq/kit/src/routes/types';
import { showDialog, showOverlay } from '@deushq/kit/src/utils/overlayUtils';
import type {
  BLEFirmwareInfo,
  IResourceUpdateInfo,
  SYSFirmwareInfo,
...
const UpdateInfoModal: FC = () => {
  ...
  const [features, setFeatures] = useState<IDeusDeviceFeatures>();
      ...
      >
        ...
        <Box my="24px">
          <Text typography="Body1Strong">
            {intl.formatMessage({
              id: 'content__connect_deus_desktop_to_upgrade',
            })}
          </Text>
              ...
              },
              {
                url: (
                  ...
                  <Text
                    ...
                    onPress={() => {
                      openUrlExternal(
                        'https://deus.so/zh_CN/download/?client=desktop',
                      );
                      closeOverlay(close);
                    }}
                  >
                    https://deus.so/download
                  </Text>
                ),
  ...
  useEffect(() => {
    (async () => {
      ...
      let deviceFeatures: IDeusDeviceFeatures;
      setIsLoading(true);
      try {
