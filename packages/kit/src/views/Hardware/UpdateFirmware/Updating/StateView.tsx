      ...
      switch (stateInfo?.type) {
        ...
        case 'manually-enter-bootloader-one':
          ...
          if (stateInfo?.content?.deviceType === 'mini') {
            ...
            stateContent.sourceSrc = require('@deushq/kit/assets/animations/lottie-deus-mini-in-bootloader-mode-disconnect-your-device.json');
            ...
            // eslint-disable-next-line global-require
            stateContent.sourceSrc = require('@deushq/kit/assets/animations/lottie-deus-classic-in-bootloader-mode.json');
            stateContent.description = intl.formatMessage({
        ...
        case 'manually-enter-bootloader-two':
          ...
          if (stateInfo?.content?.deviceType === 'mini') {
            // eslint-disable-next-line global-require
            stateContent.sourceSrc = require('@deushq/kit/assets/animations/lottie-deus-mini-in-bootloader-mode.json');
            stateContent.description = intl.formatMessage({
