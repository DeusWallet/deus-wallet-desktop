    ...
    <>
      ...
      <Dialog
        ...
        contentProps={{
          ...
          title: intl.formatMessage({
            id: 'modal__turn_on_nfc_and_let_deus_connect_your_hardware_devices',
          }),
          content: intl.formatMessage({
            id: 'modal__deus_wants_to_use_nfc_desc',
          }),
        }}
        footerButtonProps={{
          hideSecondaryAction: true,
      ...
      <Dialog
        ...
        contentProps={{
          iconType: 'danger',
          title: intl.formatMessage({
            id: 'modal__deus_lite_has_been_reset',
          }),
          content: intl.formatMessage({
            id: 'modal__deus_lite_has_been_reset_desc',
          }),
        }}
        footerButtonProps={{
          hideSecondaryAction: true,
