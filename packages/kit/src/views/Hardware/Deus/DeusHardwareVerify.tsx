...
import { setVerification } from '@deushq/kit/src/store/reducers/settings';
import { deviceUtils } from '@deushq/kit/src/utils/hardware';
import { getTimeStamp, hexlify } from '@deushq/kit/src/utils/helper';
import { CERTIFICATE_URL } from '@deushq/shared/src/config/appConfig';
...
const DeusHardwareVerifyDetail: FC<HardwareVerifyDetail> = ({ walletId }) => {
  const intl = useIntl();
        ...
        >
          <Center flex="1" alignSelf="center" mt={-6}>
            <Box w={200} h={200} ml={5}>
              <LottieView
                resizeMode="cover"
                source={require('@deushq/kit/assets/animations/lottie_searching.json')}
                autoPlay
                loop
              />
            </Box>
      ...
      return (
        ...
        >
          <Center flex="1" alignSelf="center" mt={-6}>
            <Box w={200} h={200}>
              <LottieView
                source={require('@deushq/kit/assets/animations/lottie_send_success_feedback.json')}
                autoPlay
                loop={false}
              />
            </Box>
  ...
  return (
    <Modal
      ...
      scrollViewProps={{
        ...
        children: <DeusHardwareVerifyDetail walletId={walletId} />,
      }}
    />
  );
};

export default memo(DeusHardwareVerify);
