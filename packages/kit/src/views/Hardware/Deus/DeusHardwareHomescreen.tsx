...
import type { HomescreenItem } from '@deushq/kit/src/utils/hardware/constants/homescreens';
import { getHomescreenData } from '@deushq/kit/src/utils/hardware/constants/homescreens';
import {
  generateUploadResParams,
  imageCache,
} from '@deushq/kit/src/utils/hardware/homescreens';
...
const DeusHardwareHomescreen: FC = () => {
  const intl = useIntl();
...
export default memo(DeusHardwareHomescreen);
