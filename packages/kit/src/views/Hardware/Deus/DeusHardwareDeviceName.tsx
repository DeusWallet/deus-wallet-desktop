...
const defaultName: Record<IDeusDeviceType, string> = {
  'classic': 'Deus Classic',
  'classic1s': 'Deus Classic 1S',
  'mini': 'Deus Mini',
  'touch': 'Deus Touch',
  'pro': 'Deus Pro',
};

const DeusHardwareDeviceName: FC<DeviceNameProps> = ({
  walletId,
  deviceFeatures,
}) => {
  const intl = useIntl();
...
const DeusHardwareDeviceNameModal: FC = () => {
  const intl = useIntl();
...
export default memo(DeusHardwareDeviceNameModal);
