import type { HardwareUiEventPayload } from '@deushq/kit/src/store/reducers/hardware';
...
export const CUSTOM_UI_RESPONSE = {
  ...
  CUSTOM_NEED_DEUS_BRIDGE: 'ui-custom_need_deus_bridge',
  CUSTOM_FORCE_UPGRADE_FIRMWARE: 'ui-custom_force_deus_bridge',
