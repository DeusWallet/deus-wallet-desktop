...
import { OverlayContainer } from '@deushq/components';
import { CloseBackDrop } from '@deushq/components/src/Select';
...
import PermissionDialog from '@deushq/kit/src/components/PermissionDialog/PermissionDialog';
...
export default async function showHardwarePopup({
  ...
  if (uiRequest === CUSTOM_UI_RESPONSE.CUSTOM_REQUEST_PIN_ON_DEVICE) {
    ...
    serviceHardware.sendUiResponse({
      ...
      payload: '@@DEUS_INPUT_PIN_IN_DEVICE',
    });
  ...
  if (uiRequest === CUSTOM_UI_RESPONSE.CUSTOM_NEED_DEUS_BRIDGE) {
