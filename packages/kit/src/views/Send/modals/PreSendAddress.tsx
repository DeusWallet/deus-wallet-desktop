...
import { BulkTypeEnum } from '@deushq/engine/src/types/batchTransfer';
import type { GoPlusAddressSecurity } from '@deushq/engine/src/types/goplus';
import { GoPlusSupportApis } from '@deushq/engine/src/types/goplus';
import type { INFTAsset, NFTAsset } from '@deushq/engine/src/types/nft';
import type { IEncodedTxEvm } from '@deushq/engine/src/vaults/impl/evm/Vault';
import { findLnurl } from '@deushq/engine/src/vaults/impl/lightning-network/helper/lnurl';
import type {
  INFTInfo,
  ITransferInfo,
...
import { makeTimeoutPromise } from '@deushq/shared/src/background/backgroundUtils';
import { isLightningNetworkByImpl } from '@deushq/shared/src/engine/engineConsts';
    ...
    async (toVal: string) => {
      ...
      if (transferInfos && transferInfos.length > 1) {
        ...
        try {
          ...
          const { key: errorKey = '', className } = error as DeusError;
          if (errorKey) {
            let data = {};
            if (
