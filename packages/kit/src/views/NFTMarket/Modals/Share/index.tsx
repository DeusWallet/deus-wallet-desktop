...
import LogoBlack from '@deushq/components/src/Icon/react/illus/LogoBlack';
import LogoWhite from '@deushq/components/src/Icon/react/illus/LogoWhite';
...
const getShareModule = async () => {
  ...
  return (
    await import('@deushq/shared/src/modules3rdParty/react-native-share')
  ).default;
};
