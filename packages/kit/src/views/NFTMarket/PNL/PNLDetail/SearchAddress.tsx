...
import PnlEmptyImage from '@deushq/kit/assets/nft_pnl_empty_image.png';
import PnlEmptyImageLight from '@deushq/kit/assets/nft_pnl_empty_image_light.png';
import { ModalRoutes, RootRoutes } from '@deushq/kit/src/routes/routesEnum';
