...
import ClassicDeviceIcon from '@deushq/components/img/deviceIcon_classic.png';
import MiniDeviceIcon from '@deushq/components/img/deviceIcon_mini.png';
import ProDeviceIcon from '@deushq/components/img/deviceicon_pro.png';
import TouchDeviceIcon from '@deushq/components/img/deviceicon_touch.png';
import type { DeusHardwareError } from '@deushq/engine/src/errors';
import { DeusErrorClassNames } from '@deushq/engine/src/errors';
import type { Device } from '@deushq/engine/src/types/device';
import type { Wallet } from '@deushq/engine/src/types/wallet';
import KeepDeviceAroundSource from '@deushq/kit/assets/wallet/keep_device_close.png';
import backgroundApiProxy from '@deushq/kit/src/background/instance/backgroundApiProxy';
import NeedBridgeDialog from '@deushq/kit/src/components/NeedBridgeDialog';
import { useRuntime } from '@deushq/kit/src/hooks/redux';
...
import type { SearchDevice } from '@deushq/kit/src/utils/hardware';
...
const ConnectHardwareModal: FC = () => {
  ...
  const handleScanDevice = useCallback(async () => {
    ...
    if (
      (checkBridge as unknown as DeusHardwareError).className ===
      DeusErrorClassNames.DeusHardwareError
    ) {
        ...
        ToastManager.show(
          {
            title: intl.formatMessage({
              id: (checkBridge as unknown as DeusHardwareError).key,
            }),
          },
          {
            type: 'default',
        ...
        <Box alignItems="center">
          <Box w="358px" h="220px" mb={-4}>
            <LottieView
              ...
              source={require('@deushq/kit/assets/animations/lottie_connect_deus_by_bluetooth.json')}
              autoPlay
              loop
            />
          </Box>
        ...
        children: platformEnv.isNative ? (
          ...
          <Box alignItems="center" h="full">
            <Box>
              <LottieView
                // eslint-disable-next-line global-require
                source={require('@deushq/kit/assets/animations/lottie_connect_deus_by_usb.json')}
                autoPlay
                loop
              />
            </Box>
