...
import { CustomDeusHardwareError } from '@deushq/kit/src/utils/hardware/errors';
...
const DeviceStatusCheckModal: FC = () => {
  ...
  useEffect(() => {
    ...
    async function main() {
      let features: IDeusDeviceFeatures | null = null;
      try {
        ...
        features = result as IDeusDeviceFeatures;
      } catch (e: any) {
        safeGoBack();
        const { code } = e || {};
        if (code === CustomDeusHardwareError.NeedDeusBridge) {
