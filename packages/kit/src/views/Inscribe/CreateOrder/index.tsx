...
import type { IInscriptionsOrder } from '@deushq/engine/src/vaults/impl/btc/inscribe/types';
import type { ISignedTxPro } from '@deushq/engine/src/vaults/types';
import type { InscribeModalRoutesParams } from '@deushq/kit/src/routes/Root/Modal/Inscribe';
        ...
        <VStack flex={1} justifyContent="space-between">
          ...
          >
            ...
            <Text color="text-success" typography="Caption" mt="8px">
              {intl.formatMessage({
                id: 'content__deus_does_not_charge_any_service_fees',
              })}
            </Text>
          </ScrollView>
