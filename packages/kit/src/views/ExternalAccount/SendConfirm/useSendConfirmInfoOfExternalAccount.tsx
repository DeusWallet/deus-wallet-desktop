...
import type { DeusWalletConnector } from '../../../components/WalletConnect/DeusWalletConnector';
...
type IGetExternalConnectorReturn = {
  ...
  wcConnector?: DeusWalletConnector | null;
...
export function useSendConfirmInfoOfExternalAccount({
  ...
  const getExternalConnector =
    useCallback(async (): Promise<IGetExternalConnectorReturn> => {
      ...
      let wcConnector: DeusWalletConnector | undefined | null;
