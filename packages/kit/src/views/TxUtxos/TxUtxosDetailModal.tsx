...
import { Modal, Spinner } from '@deushq/components';
import { DeusError } from '@deushq/engine/src/errors';
import type { IEncodedTxBtc } from '@deushq/engine/src/vaults/impl/btc/types';
import type { BlockBookTxDetail } from '@deushq/engine/src/vaults/utils/btcForkChain/types';
import type { TransactionDetailRoutesParams } from '@deushq/kit/src/routes/Root/Modal/TransactionDetail';
...
function TxUtxosDetailModal() {
  ...
  const fetchTxDetail = useCallback(async () => {
    try {
      ...
      throw new DeusError("Can't get transaction detail info.");
    }
    setIsLoading(false);
