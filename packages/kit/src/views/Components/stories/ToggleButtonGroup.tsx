...
import { Box, ToggleButtonGroup } from '@deushq/components';
...
const buttons: ToggleButtonProps[] = [
  {
    text: 'BTC',
    leftImage: 'https://uni.deus-asset.com/static/chain/btc.png',
  },
  {
    text: '',
    leftIcon: 'StarMini',
  ...
  {
    text: '',
    leftImage: 'https://uni.deus-asset.com/static/chain/bsc.png',
  },
  {
    text: 'polygon',
  },
