...
import { revokeUrl } from '@deushq/engine/src/managers/revoke';
import type { Account } from '@deushq/engine/src/types/account';
import type { Network } from '@deushq/engine/src/types/network';
import btcSetting from '@deushq/engine/src/vaults/impl/btc/settings';
import tbtcSetting from '@deushq/engine/src/vaults/impl/tbtc/settings';
import {
  HomeRoutes,
  InscribeModalRoutes,
  MainRoutes,
...
const FlatListGasPriceItem = ({ item, index }: FlatListItemProps) => {
  ...
  const { network } = useNetwork({
    networkId: isAllNetworks(networkId) ? DeusNetwork.eth : networkId,
  });
