...
import type { ForwardRefHandle } from '@deushq/app/src/views/NestedTabView/NestedTabView';
import { Box, useIsVerticalLayout, useUserDevice } from '@deushq/components';
...
import { DeusPerfTraceLog } from '../../components/DeusPerfTraceLog';
    ...
    () => (
      ...
      >
        <LazyRenderCurrentHomeTab homeTabName={WalletHomeTabEnum.Tokens}>
          <Tabs.ScrollView>
            <DeusPerfTraceLog name="App RootTabHome AssetsList render" />
