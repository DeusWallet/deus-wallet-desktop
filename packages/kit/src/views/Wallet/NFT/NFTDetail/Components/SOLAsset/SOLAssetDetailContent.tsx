...
import useModalClose from '@deushq/components/src/Modal/Container/useModalClose';
...
import { getContentWithAsset } from '@deushq/engine/src/managers/nft';
import type { NFTAsset } from '@deushq/engine/src/types/nft';
import { WALLET_TYPE_WATCHING } from '@deushq/engine/src/types/wallet';
import { generateUploadNFTParams } from '@deushq/kit/src/utils/hardware/nftUtils';
import NFTDetailMenu from '@deushq/kit/src/views/Overlay/NFTDetailMenu';
...
import type { DeviceUploadResourceParams } from '@deusfe/hd-core';
