...
import { Box, Pressable, Typography } from '@deushq/components';
  ...
  const topApr = useMemo(() => {
    ...
    return items.kele > items.lido
      ? {
          ...
          logo: require('@deushq/kit/assets/staking/kele_pool.png'),
        }
      : {
          name: 'Lido • Ethereum',
          value: `${formatAmount(items.lido, 2)}%`,
          logo: require('@deushq/kit/assets/staking/lido_pool.png'),
        };
