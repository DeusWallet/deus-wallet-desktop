...
import { wait } from '@deusfe/hd-core';
...
import PNG from '@deushq/kit/assets/discover/header_bg.png';
import PNGLight from '@deushq/kit/assets/discover/header_bg_light.png';
      ...
      >
        ...
        <Center position="absolute" w="full" h="full">
          ...
          <Typography.Body2 color="text-subdued" mt="4">
            {intl.formatMessage({
              id: 'form__explore_web3_world_with_deus_a_safer_and_simpler_way',
            })}
          </Typography.Body2>
        </Center>
      </Box>
