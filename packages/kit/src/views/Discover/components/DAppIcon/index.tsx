...
import { Box, Icon, Image, NetImage } from '@deushq/components';
import DAppIconBG from '@deushq/kit/assets/DAppIcon_bg.png';
import multichainPNG from '@deushq/kit/assets/dappIcon_multichain.png';
