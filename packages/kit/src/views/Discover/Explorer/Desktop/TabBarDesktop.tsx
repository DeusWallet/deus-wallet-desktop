...
import { Box, Button, Pressable, Typography } from '@deushq/components';
import ScrollableButtonGroup from '@deushq/components/src/ScrollableButtonGroup/ScrollableButtonGroup';
import ShortcutsTooltip from '@deushq/components/src/ShortcutsTooltip';
import dAppFavicon from '@deushq/kit/assets/dapp_favicon.png';
import platformEnv from '@deushq/shared/src/platformEnv';
import {
  ExplorerShortcutEvents,
  getShortcutsMap,
} from '@deushq/shared/src/shortcuts/shortcuts.enum';
