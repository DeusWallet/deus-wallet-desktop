...
const TEST_URL = 'https://node.deustest.com/health';
// const TEST_URL = 'https://fiat.deuscn.com/setting/list';
...
// try{$$axios.get('https://node.deustest.com/health')}catch(error){console.error('axios ERROR >>>>>>> :',error)}
