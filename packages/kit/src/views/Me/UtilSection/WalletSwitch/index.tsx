...
import { Box, Icon, SectionList, Typography } from '@deushq/components';
    ...
    () => (
      ...
      >
        ...
        <Typography.Body2Strong ml={2}>
          {intl.formatMessage({
            id: 'content__when_the_option_is_turned_on_the_inject_cnonection_method_for_that_wallet_will_be_overridden_by_deus',
          })}
