...
import { Box, Icon, Pressable, Text } from '@deushq/components';
...
const ExtRateUrl = {
  'chrome':
    'https://chrome.google.com/webstore/detail/deus/jnmbobjmhlngoefaiojfljckilhhlhcj',
  'firefox': 'https://addons.mozilla.org/zh-CN/firefox/addon/deus/reviews/',
  'edge':
    'https://microsoftedge.microsoft.com/addons/detail/deus/obffkkagpmohennipjokmpllocnlndac',
};
