...
import { useHelpLink } from '@deushq/kit/src/hooks/useHelpLink';
import { setDevMode } from '@deushq/kit/src/store/reducers/settings';
    ...
    <Box w="full" mb="6">
      ...
      >
        ...
        <Pressable
          ...
          borderBottomWidth="1"
          borderBottomColor="divider"
          onPress={() => openUrlExternal('https://www.discord.gg/deus')}
        >
        ...
        <Pressable
          ...
          py={4}
          px={{ base: 4, md: 6 }}
          onPress={() => openUrlExternal('https://www.twitter.com/deushq')}
        >
