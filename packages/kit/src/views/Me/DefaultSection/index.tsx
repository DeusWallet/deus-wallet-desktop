...
import { HomeRoutes, RootRoutes } from '@deushq/kit/src/routes/routesEnum';
...
type NavigationProps = NativeStackNavigationProp<
  HomeRoutesParams,
  HomeRoutes.ScreenDeusLiteDetail
>;
        ...
        {supportedNFC && (
          <>
            <Pressable
              ...
              px={{ base: 4, md: 6 }}
              onPress={() => {
                navigation.navigate(HomeRoutes.ScreenDeusLiteDetail);
              }}
            >
              <Icon name="DeusLiteOutline" />
              <Text
                typography={{ sm: 'Body1Strong', md: 'Body2Strong' }}
                flex="1"
                numberOfLines={1}
              ...
              >
                {intl.formatMessage({
                  id: 'app__hardware_name_deus_lite',
                })}
              </Text>
              <Box>
                <Icon name="ChevronRightMini" color="icon-subdued" size={20} />
