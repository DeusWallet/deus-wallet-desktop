...
import { DEUS_APP_DEEP_LINK } from '../../../../components/WalletConnect/walletConnectConsts';
...
function deviceInfo() {
  ...
  return {
    ...
    platform: process.env.DEUS_PLATFORM ?? 'unknown',
...
const DeusMigrateQRCodePrefix = `${DEUS_APP_DEEP_LINK}migrate/`;
