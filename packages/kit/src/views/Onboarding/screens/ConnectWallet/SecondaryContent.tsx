...
import { Box, Center, Hidden, ToastManager } from '@deushq/components';
import LogoLedger from '@deushq/kit/assets/onboarding/logo_ledger.png';
import LogoTrezor from '@deushq/kit/assets/onboarding/logo_trezor.png';
