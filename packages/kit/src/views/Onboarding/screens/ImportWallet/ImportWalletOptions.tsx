...
import type { IconProps } from '@deushq/components/src/Icon';
import KeyTagPNG from '@deushq/kit/assets/onboarding/import_with_keytag.png';
import DeusLitePNG from '@deushq/kit/assets/onboarding/import_with_lite.png';
...
export const OptionDeusLite: FC<OptionProps> = ({
  title,
  description,
  onPress,
}) => (
  <Option
    title={title}
    description={description}
    icon="DeusLiteOutline"
    onPress={onPress}
  >
    <Center>
      <Image source={DeusLitePNG} w="224px" h="64px" />
    </Center>
  </Option>
);
...
export const OptioniCloud: FC<OptionProps> = ({
  ...
  <Option
    ...
    isLoading={isLoading}
  >
    <IconToIconIllus leftIcon="CloudSolid" rightIcon="DeusLogoSolid" />
  </Option>
);
