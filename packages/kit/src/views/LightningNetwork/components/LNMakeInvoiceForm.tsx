...
import { Box, Form, Text, useIsVerticalLayout } from '@deushq/components';
import type { Token } from '@deushq/engine/src/types/token';
import type { IInvoiceConfig } from '@deushq/engine/src/vaults/impl/lightning-network/types/invoice';
import { FormatCurrencyTokenOfAccount } from '@deushq/kit/src/components/Format';
import { TxInteractInfo } from '@deushq/kit/src/views/TxDetail/components/TxInteractInfo';
