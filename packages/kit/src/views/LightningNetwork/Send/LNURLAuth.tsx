...
import type { LNURLAuthServiceResponse } from '@deushq/engine/src/vaults/impl/lightning-network/types/lnurl';
...
const LNURLAuth = () => {
  ...
  useEffect(() => {
    if (lnurlDetails.action === 'register') {
      setMessages({
        allowText: intl.formatMessage({
          id: 'content__allow_dapp_to_register_with_deus',
        }),
    ...
    if (lnurlDetails.action === 'link') {
      setMessages({
        allowText: intl.formatMessage({
          id: 'content__allow_dapp_to_link_with_deus',
        }),
        title: intl.formatMessage({
    ...
    if (lnurlDetails.action === 'auth') {
      setMessages({
        allowText: intl.formatMessage({
          id: 'content__allow_dapp_to_connect_with_deus',
        }),
        title: intl.formatMessage({
    ...
    setMessages({
      allowText: intl.formatMessage({
        id: 'content__allow_dapp_to_login_with_deus',
      }),
      title: intl.formatMessage({
