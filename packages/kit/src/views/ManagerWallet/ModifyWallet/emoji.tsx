...
import { Box, Center, Modal, Pressable, Text } from '@deushq/components';
import RecyclerListView, {
  DataProvider,
  LayoutProvider,
} from '@deushq/components/src/RecyclerListView';
...
import type { EmojiTypes } from '@deushq/shared/src/utils/emojiUtils';
import { colors, emojiList } from '@deushq/shared/src/utils/emojiUtils';
