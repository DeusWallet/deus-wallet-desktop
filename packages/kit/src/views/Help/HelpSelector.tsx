...
import type { SubmitRequestModalRoutesParams } from '@deushq/kit/src/routes';
import {
  ModalRoutes,
  RootRoutes,
  ...
  const options: GroupOption[] = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: intl.formatMessage({ id: 'title__buy_deus_hardware' }),
          value: 'shop',
          iconProps: {
    ...
    setTimeout(() => {
      switch (value) {
        ...
        case 'shop':
          openUrlByWebview(
            'https://shop.deus.so/',
            intl.formatMessage({ id: 'title__buy_deus_hardware' }),
          );
          break;
        case 'download':
          openUrlByWebview(
