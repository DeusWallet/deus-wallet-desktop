...
import { useAutoUpdate } from '@deushq/kit/src/hooks/redux';
...
import { disable } from '@deushq/kit/src/store/reducers/autoUpdater';
      ...
      >
        ...
        <Box flex={1} mt={0.5}>
          <Text flex={1} typography="Body2Strong" color="text-default">
            {intl.formatMessage(
              { id: 'msg__update_to_deus_str_is_available' },
