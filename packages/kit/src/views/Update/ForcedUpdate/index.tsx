...
import useBackHandler from '@deushq/kit/src/hooks/useBackHandler';
import type { UpdateFeatureRoutesParams } from '@deushq/kit/src/routes/Root/Modal/UpdateFeature';
        ...
        children: changeLog ? (
          <>
            ...
            <Typography.DisplayMedium>
              {intl.formatMessage(
                { id: 'modal__what_is_new_in_deus_str' },
