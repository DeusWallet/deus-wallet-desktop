...
import { Box, Center, Empty, HStack, Text, VStack } from '@deushq/components';
import type { DBAccountDerivation } from '@deushq/engine/src/types/accountDerivation';
      ...
      <Box flex={1}>
        <HStack alignItems="center" space={4}>
          <WalletAvatar
            ...
            hwWalletType={
              (wallet.deviceType as IDeusDeviceType) ||
