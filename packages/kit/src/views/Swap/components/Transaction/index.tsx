...
import Logo from '@deushq/components/src/Icon/react/illus/Logo';
      ...
      const socketOption: Option[] = [
        {
          ...
          label: 'Socketscan',
          logoURI: 'https://common.deus-asset.com/logo/SocketBridge.png',
          value: 'Socketscan',
...
type TransactionDeusFeesProps = { tx: TransactionDetails };
const TransactionDeusFees: FC<TransactionDeusFeesProps> = ({ tx }) => {
    ...
    <Box>
      ...
      <Box>
        ...
        <VStack space={4}>
          ...
          {tx.percentageFee ? (
            <TransactionField
              label={intl.formatMessage({ id: 'form__included_deus_fee' })}
            >
              <TransactionDeusFees tx={tx} />
            </TransactionField>
          ) : null}
          {swftcOrderId ? (
            <TransactionField
