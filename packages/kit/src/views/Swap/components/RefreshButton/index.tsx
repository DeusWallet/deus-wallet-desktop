...
import { Center, LottieView, useTheme } from '@deushq/components';
      ...
      >
        <Center w="5" h="5">
          <LottieView
            ...
            source={
              themeVariant === 'light'
                ? require('@deushq/kit/assets/animations/lottie_deus_swap_refresh_light.json')
                : require('@deushq/kit/assets/animations/lottie_deus_swap_refresh_dark.json')
            }
          />
        </Center>
      </Animated.View>
