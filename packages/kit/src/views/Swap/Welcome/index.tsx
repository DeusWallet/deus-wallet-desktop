...
import { Box, Center, Modal, Typography } from '@deushq/components';
    ...
    <Box>
      <Center mt="8" mb="10">
        <Typography.DisplayLarge>
          {intl.formatMessage({ id: 'title__welcome_to_deus_swap' })}
        </Typography.DisplayLarge>
        <Typography.Body2 color="text-subdued" mt="2">
          {intl.formatMessage({ id: 'title__welcome_to_deus_swap_desc' })}
        </Typography.Body2>
      </Center>
      <Box>
