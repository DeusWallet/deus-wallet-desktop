...
import type { DeviceState } from '@deushq/kit/src/components/WalletSelector/WalletAvatar';
import {
  WalletAvatarPro,
  useHardwareWalletInfo,
} from '@deushq/kit/src/components/WalletSelector/WalletAvatar';
import {
  useActiveWalletAccount,
  useNavigationActions,
} from '@deushq/kit/src/hooks';
import { useWalletName } from '@deushq/kit/src/hooks/useWalletName';
