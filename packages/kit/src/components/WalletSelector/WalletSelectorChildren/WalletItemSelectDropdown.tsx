...
import type { OnCloseCallback } from '@deushq/components/src/Dialog/components/FooterButton';
import type { IWallet } from '@deushq/engine/src/types';
import { WALLET_TYPE_HW } from '@deushq/engine/src/types/wallet';
import backgroundApiProxy from '@deushq/kit/src/background/instance/backgroundApiProxy';
import type { IHardwareDeviceStatusMap } from '@deushq/kit/src/components/NetworkAccountSelector/hooks/useDeviceStatusOfHardwareWallet';
import { ValidationFields } from '@deushq/kit/src/components/Protected';
import { useAppSelector } from '@deushq/kit/src/hooks';
import useAppNavigation from '@deushq/kit/src/hooks/useAppNavigation';
import useLocalAuthenticationModal from '@deushq/kit/src/hooks/useLocalAuthenticationModal';
import type { RootNavContainerRef } from '@deushq/kit/src/provider/NavigationProvider';
import {
...
import { getHomescreenKeys } from '@deushq/kit/src/utils/hardware/constants/homescreens';
import { showDialog } from '@deushq/kit/src/utils/overlayUtils';
import showDeviceAdvancedSettings from '@deushq/kit/src/views/Hardware/Deus/DeviceAdvancedSettingsBottomSheetModal';
import HardwareLoadingDialog from '@deushq/kit/src/views/Hardware/Deus/DeusHardwareConnectDialog';
import ManagerWalletDeleteDialog from '@deushq/kit/src/views/ManagerWallet/DeleteWallet';
import type { DeleteWalletProp } from '@deushq/kit/src/views/ManagerWallet/DeleteWallet';
      ...
      <WalletMenuItem
        onPress={() => {
          navigation.navigate(RootRoutes.Modal, {
            ...
            params: {
              screen: DeusHardwareModalRoutes.DeusDeviceWalletNameModal,
              params: {
                walletId: wallet?.id ?? '',
              },
            },
      ...
      <WalletMenuItem
        onPress={() => {
          navigation.navigate(RootRoutes.Modal, {
            screen: ModalRoutes.DeusHardware,
            params: {
              screen: DeusHardwareModalRoutes.DeusHardwareDeviceNameModal,
              params: {
                walletId: wallet?.id ?? '',
                deviceName: '',
              },
        ...
        <WalletMenuItem
          onPress={() => {
            navigation.navigate(RootRoutes.Modal, {
              screen: ModalRoutes.DeusHardware,
              params: {
                screen: DeusHardwareModalRoutes.DeusHardwareHomeScreenModal,
                params: {
                  walletId: wallet?.id ?? '',
      ...
      <WalletMenuItem
        onPress={() => {
          navigation.navigate(RootRoutes.Modal, {
            screen: ModalRoutes.DeusHardware,
            params: {
              screen: DeusHardwareModalRoutes.DeusHardwareDetailsModal,
              params: {
                walletId: wallet?.id ?? '',
              },
            },
