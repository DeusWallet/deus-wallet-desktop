...
import { Box, Center, Icon, Image, Text } from '@deushq/components';
import ClassicIcon from '@deushq/components/img/deviceIcon_classic.png';
import MiniIcon from '@deushq/components/img/deviceIcon_mini.png';
import ProIcon from '@deushq/components/img/deviceicon_pro.png';
import TouchIcon from '@deushq/components/img/deviceicon_touch.png';
import type { TypographyStyle } from '@deushq/components/src/Typography';
import type { IWallet } from '@deushq/engine/src/types';
import { WALLET_TYPE_HW } from '@deushq/engine/src/types/wallet';
import { getDeviceTypeByDeviceId } from '@deushq/kit/src/utils/hardware';
...
import { defaultAvatar } from '@deushq/shared/src/utils/emojiUtils';
...
export function useHardwareWalletInfo({
  ...
  const hwInfo = useMemo(() => {
    ...
    let hwWalletType = deviceType as IDeusDeviceType;
    if (!hwWalletType) {
