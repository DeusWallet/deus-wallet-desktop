...
import type { IExternalAccountInfoWalletImage } from '@deushq/engine/src/dbs/simple/entity/SimpleDbEntityWalletConnect';

import type { DeusWalletConnector } from './DeusWalletConnector';
