...
import { getOrCreateTransport } from './DeusWalletConnectSocketTransport';
import { WALLET_CONNECT_BRIDGE } from './walletConnectConsts';

import type { DeusWalletConnectSocketTransport } from './DeusWalletConnectSocketTransport';
...
export class DeusWalletConnector extends Connector {
  constructor(
    ...
    let transport: DeusWalletConnectSocketTransport | undefined;
  ...
  get socketTransport(): DeusWalletConnectSocketTransport | undefined {
    // @ts-ignore
    return this._transport as DeusWalletConnectSocketTransport | undefined;
  }
