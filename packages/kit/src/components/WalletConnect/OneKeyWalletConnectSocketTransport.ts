...
// @ts-ignore
export class DeusWalletConnectSocketTransport extends SocketTransport {
...
const transports: Record<
  string,
  DeusWalletConnectSocketTransport | undefined
> = {};
...
export function getOrCreateTransport({
  ...
  if (!transport) {
    transport = new DeusWalletConnectSocketTransport({
