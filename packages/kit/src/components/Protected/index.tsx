...
import { Box, Spinner, ToastManager, Typography } from '@deushq/components';
import { WALLET_TYPE_EXTERNAL } from '@deushq/engine/src/types/wallet';
import backgroundApiProxy from '@deushq/kit/src/background/instance/backgroundApiProxy';
import {
  useAppSelector,
  useData,
  useGetWalletDetail,
} from '@deushq/kit/src/hooks/redux';
...
const Protected: FC<ProtectedProps> = ({
  ...
  const [deviceFeatures, setDeviceFeatures] = useState<IDeusDeviceFeatures>();
