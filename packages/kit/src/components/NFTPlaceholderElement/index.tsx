...
import { Box, Center, Icon, Image, NetImage } from '@deushq/components';
import CollectionDefaultLogo from '@deushq/components/img/collection_default_logo.png';
import NFTPlaceholderBG from '@deushq/components/img/NFT_placeholder_bg.png';
