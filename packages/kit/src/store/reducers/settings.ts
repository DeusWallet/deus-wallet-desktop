...
import type { ThemeVariant } from '@deushq/components/src/Provider/theme';
...
import { defaultHapticStatus } from '@deushq/shared/src/haptics';
import platformEnv from '@deushq/shared/src/platformEnv';
import { EDeusDomain } from '@deushq/shared/types';
...
const initialState: SettingsState = {
  ...
  hardwareConnectSrc: EDeusDomain.DEUS_SO,
...
export const THEME_PRELOAD_STORAGE_KEY = 'DEUS_THEME_PRELOAD';
