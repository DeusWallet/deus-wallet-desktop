...
import { setIsPasswordLoadedInVault } from '@deushq/kit/src/store/reducers/data';
import { refreshHistory } from '@deushq/kit/src/store/reducers/refresher';
import type {
  SendConfirmOnSuccessData,
  SendConfirmResendActionInfo,
} from '@deushq/kit/src/views/Send/types';
import { isEvmNetworkId } from '@deushq/kit/src/views/Swap/utils';
import {
  backgroundClass,
  backgroundMethod,
