...
import { clearTranslations } from '@deushq/kit/src/store/reducers/data';
import {
  addBookmark,
  cleanOldState,
  clearHistory,
...
} from '@deushq/kit/src/store/reducers/discover';
import { getDefaultLocale } from '@deushq/kit/src/utils/locale';
import { getWebTabs } from '@deushq/kit/src/views/Discover/Explorer/Controller/useWebTabs';
import type { MatchDAppItemType } from '@deushq/kit/src/views/Discover/Explorer/explorerUtils';
import type {
  BannerType,
  BookmarkItem,
  CategoryType,
  DAppItemType,
  GroupDappsType,
} from '@deushq/kit/src/views/Discover/type';
import {
  backgroundClass,
  backgroundMethod,
