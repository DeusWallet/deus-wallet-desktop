...
import * as nft from '@deushq/engine/src/managers/nft';
...
import { setNFTPriceType } from '@deushq/kit/src/store/reducers/nft';
...
class ServiceNFT extends ServiceBase {
  ...
  async getPNLData({
    ...
    if (!success) {
      ...
      throw new DeusInternalError('data load error');
    }
    return data;
  }
