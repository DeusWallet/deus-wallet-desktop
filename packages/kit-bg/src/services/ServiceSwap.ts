...
import type { ISwftcCoin } from '@deushq/engine/src/dbs/simple/entity/SimpleDbEntitySwap';
...
import {
  ...
  switchTokens,
} from '@deushq/kit/src/store/reducers/swap';
import {
  clearTransactions,
  ...
  setWrapperTokens,
  updateTokenList,
} from '@deushq/kit/src/store/reducers/swapTransactions';
import type { SendConfirmParams } from '@deushq/kit/src/views/Send/types';
import type {
  FetchQuoteParams,
  FieldType,
  QuoteData,
...
} from '@deushq/kit/src/views/Swap/typings';
import {
  convertBuildParams,
  formatAmount,
  ...
  stringifyTokens,
  tokenEqual,
} from '@deushq/kit/src/views/Swap/utils';
import {
  backgroundClass,
  backgroundMethod,
  bindThis,
...
export default class ServiceSwap extends ServiceBase {
  ...
  async setDefaultInputToken() {
    ...
    const USDC = {
      ...
      decimals: 6,
      logoURI:
        'https://common.deus-asset.com/token/evm-1/0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48.jpg',
      impl: 'evm',
      chainId: '1',
    } as ServerToken;

    const network = await engine.getNetwork(DeusNetwork.eth);
