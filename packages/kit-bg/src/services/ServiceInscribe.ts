...
import {
  ...
  getGetblockEndpoint,
  getMempoolEndpoint,
} from '@deushq/engine/src/endpoint';
import { InscribeFileTooLargeError } from '@deushq/engine/src/errors';
import { getNetworkImpl } from '@deushq/engine/src/managers/network.utils';
import {
  INSCRIBE_ACCOUNT_STORAGE_KEY,
  INSCRIPTION_PADDING_SATS_VALUES,
  MULTIPLE_INSCRIPTIONS_ENABLED,
} from '@deushq/engine/src/vaults/impl/btc/inscribe/consts';
import { InscribeAccount } from '@deushq/engine/src/vaults/impl/btc/inscribe/InscribeAccount';
import {
  Tx,
  secp256k1SchnorrSdk,
} from '@deushq/engine/src/vaults/impl/btc/inscribe/sdk';
import type {
  ...
  ScriptData,
  TxTemplate,
} from '@deushq/engine/src/vaults/impl/btc/inscribe/types';
import type { ISignedTxPro } from '@deushq/engine/src/vaults/types';
import type { IEncodedTxBtc } from '@deushq/engine/src/vaults/utils/btcForkChain/types';
import { AddressEncodings } from '@deushq/engine/src/vaults/utils/btcForkChain/types';
import {
  decodeBtcRawTx,
  tapRootAccountUtils,
} from '@deushq/engine/src/vaults/utils/btcForkChain/utils';
import type VaultBtcFork from '@deushq/engine/src/vaults/utils/btcForkChain/VaultBtcFork';
import {
  convertFeeNativeToValue,
  convertFeeValueToNative,
} from '@deushq/engine/src/vaults/utils/feeInfoUtils';
...
import { JsonRPCRequest } from '@deushq/shared/src/request/JsonRPCRequest';
import appStorage from '@deushq/shared/src/storage/appStorage';
import bufferUtils from '@deushq/shared/src/utils/bufferUtils';
...
export default class ServiceInscribe extends ServiceBase {
  ...
  async createInscribeOrder({
    ...
    for (let i = 0; i < contents.length; i += 1) {
      ...
      fetch("https://node.deustest.com/getblock-btc-mainnet", {
