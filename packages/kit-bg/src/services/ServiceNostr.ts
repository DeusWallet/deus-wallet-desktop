...
import {
  ...
  getNostrPath,
  validateEvent,
} from '@deushq/engine/src/vaults/impl/nostr/helper/NostrSDK';
import type {
  INostrRelays,
  NostrEvent,
} from '@deushq/engine/src/vaults/impl/nostr/helper/types';
import type VaultNostr from '@deushq/engine/src/vaults/impl/nostr/Vault';
...
export default class ServiceNostr extends ServiceBase {
  ...
  async getNostrAccount({
    ...
    const networkId = DeusNetwork.nostr;
