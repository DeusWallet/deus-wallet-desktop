...
import type { ISimpleSearchHistoryToken } from '@deushq/engine/src/dbs/simple/entity/SimpleDbEntityMarket';
...
import type {
  ...
  MarketTokenItem,
  MarketTopTabName,
} from '@deushq/kit/src/store/reducers/market';
import {
...
import type { ServerToken } from '@deushq/kit/src/store/typings';
