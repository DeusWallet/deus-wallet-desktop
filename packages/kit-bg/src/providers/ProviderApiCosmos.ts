...
import { web3Errors } from '@deusfe/cross-inpage-provider-errors';
import { IInjectedProviderNames } from '@deusfe/cross-inpage-provider-types';
import { PubKey } from 'cosmjs-types/cosmos/crypto/ed25519/keys';
import { AuthInfo, TxBody } from 'cosmjs-types/cosmos/tx/v1beta1/tx';

import { CommonMessageTypes } from '@deushq/engine/src/types/message';
import type { BroadcastMode } from '@deushq/engine/src/vaults/impl/cosmos/NodeClient';
import type { StdSignDoc } from '@deushq/engine/src/vaults/impl/cosmos/sdk/amino/types';
import { deserializeTx } from '@deushq/engine/src/vaults/impl/cosmos/sdk/txBuilder';
import { TransactionWrapper } from '@deushq/engine/src/vaults/impl/cosmos/sdk/wrapper';
import { getAminoSignDoc } from '@deushq/engine/src/vaults/impl/cosmos/sdk/wrapper/utils';
import type VaultCosmos from '@deushq/engine/src/vaults/impl/cosmos/Vault';
...
import { IMPL_COSMOS } from '@deushq/shared/src/engine/engineConsts';
...
import type { IJsBridgeMessagePayload } from '@deusfe/cross-inpage-provider-types';
...
class ProviderApiCosmos extends ProviderApiBase {
  ...
  private _getKey = async (
    ...
    const vault = (await this.backgroundApi.engine.getVault({
      networkId: DeusNetwork.cosmoshub,
      accountId,
    })) as VaultCosmos;
