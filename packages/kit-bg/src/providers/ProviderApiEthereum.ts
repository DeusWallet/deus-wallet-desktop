...
import type VaultEvm from '@deushq/engine/src/vaults/impl/evm/Vault';
import type {
  IEncodedTxEvm,
  IUnsignedMessageEvm,
} from '@deushq/engine/src/vaults/impl/evm/Vault';
...
} from '@deushq/shared/src/providerApis/ProviderApiEthereum/ProviderApiEthereum.types';
