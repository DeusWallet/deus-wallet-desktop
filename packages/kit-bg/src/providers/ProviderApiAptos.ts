...
import { AptosMessageTypes } from '@deushq/engine/src/types/message';
import type {
  IEncodedTxAptos,
  SignMessagePayload,
  SignMessageResponse,
} from '@deushq/engine/src/vaults/impl/apt/types';
import {
...
} from '@deushq/engine/src/vaults/impl/apt/utils';
import type VaultAptos from '@deushq/engine/src/vaults/impl/apt/Vault';
import {
  hexlify,
  stripHexPrefix,
...
import { IMPL_APTOS } from '@deushq/shared/src/engine/engineConsts';
