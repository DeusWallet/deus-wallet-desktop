...
// import { ETHMessageTypes } from '@deushq/engine/src/types/message';
import { ETHMessageTypes } from '@deushq/engine/src/types/message';
import type { EvmExtraInfo, Network } from '@deushq/engine/src/types/network';
import type { IUnsignedMessageEvm } from '@deushq/engine/src/vaults/impl/evm/Vault';
import { IEncodedTxEvm } from '@deushq/engine/src/vaults/impl/evm/Vault';
import type { IEncodedTxSTC } from '@deushq/engine/src/vaults/impl/stc/types';
...
import { IMPL_STC } from '@deushq/shared/src/engine/engineConsts';
import { fixAddressCase } from '@deushq/shared/src/engine/engineUtils';
...
class ProviderApiStarcoin extends ProviderApiBase {
   ...
   * Open @type {import("@deushq/kit/src/views/DappModals/Multicall.tsx").default} contract modal
   * Open @type {import("@deushq/kit/src/views/DappModals/SendConfirm.tsx").default} send modal
   * Open @type {import("@deushq/kit/src/views/DappModals/Approve.tsx").default} approve modal
   *
   * Example:
  ...
  /** Sign transaction
   * Open @type {import("@deushq/kit/src/views/DappModals/Signature.tsx").default} modal
   */
  @providerApiMethod()
